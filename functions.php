...
function pleiades17_scripts() {
	...
	// NAVIGATION
	if (has_nav_menu('top')) {
		wp_enqueue_script('pleiades17-navigation', get_theme_file_uri('/assets/js/navigation.js'), array('jquery'), '1.0', true);
...
/**********************************************************
// Check conditional if is custom post type
***********************************************************/
...
function admin_default_page() {
	return 'http://localhost/~ronyortiz/sites2017/unicad17/';
}
add_filter('login_redirect', 'admin_default_page');

// ALTERN METHOD Block Access to /wp-admin for non admins.
...
/**********************************************************
// Limit default 'recent posts' widget to certain categories
***********************************************************/
...
function new_excerpt_more($more) {
       global $post;
	return '<p><a class="moretag" href="'. get_permalink($post->ID) . '">Leer más...</a></p>';
}
